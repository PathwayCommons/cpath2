...
import cpath.service.api.CvRepository;
...
class OntologyManager extends BiopaxOntologyManager implements CvRepository
{
  ...
  public OntologyManager(Properties oboProperties, String xmlBase) {
    super(oboProperties);
  ...
  public <T extends ControlledVocabulary> T getControlledVocabulary(String urn, Class<T> cvClass)
  {
