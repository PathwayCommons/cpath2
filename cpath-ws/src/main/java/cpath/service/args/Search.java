...
public class Search extends ServiceQuery {
  ...
  @ApiParam(value = "Query string (full-text search supports Lucene query syntax).", required = true,
    example = "xrefid:FGFR*")
  private String q;
  @ApiParam(value = "Filter by BioPAX L3 class name (case-insensitive).", example = "pathway")
  ...
  @Min(0)
  @ApiParam(value = "Pagination: page number (>=0) of the full-text search results.", example = "0", required = false)
