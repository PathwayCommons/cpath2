...
CPATH2_OPTS="-Dfile.encoding=UTF-8 -Xss65536k -Xmx10g -DCPATH2_HOME=$CPATH2_HOME -Djava.io.tmpdir=$CPATH2_HOME/tmp -Dnet.sf.ehcache.skipUpdateCheck=true -Dpaxtools.CollectionProvider=org.biopax.paxtools.trove.TProvider"
