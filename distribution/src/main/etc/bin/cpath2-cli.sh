...
CPATH2_OPTS="-Dfile.encoding=UTF-8 -Xmx32g -DCPATH2_HOME=$CPATH2_HOME -Djava.io.tmpdir=$CPATH2_HOME/tmp -Dpaxtools.CollectionProvider=org.biopax.paxtools.trove.TProvider -Dspring.profiles.active=prod -Dcpath.idsSummary.output=idsSummary.txt"
