...
public class DataIntegration implements CommandLineRunner {
  private static final Logger LOG = LoggerFactory.getLogger(DataIntegration.class);
  ...
  public static void main(String[] args) {
    SpringApplication consoleApp = new SpringApplication(DataIntegration.class);
...
//context.getBean(CPathService.class).init();//do not (that's for the web app)
   ...
   *
   * @param analysisClass a class that implements {@link cpath.service.Analysis}
   * @param readOnly
   */
