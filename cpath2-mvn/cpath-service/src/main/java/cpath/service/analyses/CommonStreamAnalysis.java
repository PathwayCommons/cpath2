...
/**
 * Common stream query. User provides a source set, the query returns paths from
 * source objects to their common (up/down)stream.
 *
 * @author ozgun
 *
 */
public class CommonStreamAnalysis implements Analysis {

	static Log log = LogFactory.getLog(CommonStreamAnalysis.class);
