            ...
            case CREATE_INDEX:
            	if(commandParameters != null) {
                    ...
                    case MAIN :
                    	...
                    	//TODO for each biopax object, create extra index fields, "datasources" and "organisms", using Hibernate Search / Lucene API directly. Get values/keywords from special (generated by Normalizer) relationship xrefs!
                    	break;
            		}
            	}
            	break;
