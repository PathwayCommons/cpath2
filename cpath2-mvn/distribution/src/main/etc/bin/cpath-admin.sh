...
# for jprofiling
#$JAVA_HOME/bin/java -agentpath:/data/local/jprofiler6/bin/linux-x64/libjprofilerti.so=port=48000,nowait -Dfile.encoding=UTF-8 -Xss65536k -Xmx8g -DCPATH2_HOME=$CPATH2_HOME -Djava.io.tmpdir=$CPATH2_HOME/tmp -jar cpath-admin.jar $1 $2 $3 $4 $5
