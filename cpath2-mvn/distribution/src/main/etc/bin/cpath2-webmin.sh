...
##
# cPath2 ${version} web admin start script.
#
...
if [ -z "$1" ]; then 
	$JAVA_HOME/bin/java -jar cpath2-webmin.jar --help
else
	$JAVA_HOME/bin/java  $CPATH2_TUNING_OPTS $CPATH2_OPTS -jar cpath2-webmin.jar $1 $2 $3 $4 $5 $6
fi
